...
fixed4 frag (v2f i) : SV_Target
{
    ...
    fixed3 startColor = fixed3(140.0 / 255.0, 0.0 / 255.0, 255.0 / 255.0);
    fixed3 endColor = fixed3(247.0 / 255.0, 0.0 / 255.0, 255.0 / 255.0);

    // Calculate the lerp factor using a sin() function
    float lerpFactor = (cos(_Time.y * _Speed + uv.x * 3.14159265) + 1.0) / 2.0;
